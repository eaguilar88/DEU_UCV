...
INSERT INTO deu.users (ci, username, first_name, last_name, date_of_birth, gender, education, address, role, password) VALUES
  ('183245415', 'eaguilar@email.com', 'Ellery', 'Aguilar', '1988-09-03', 'masculino', 'universitaria_incompleta', 'caracas', 'admin', '$2a$10$rFfAKJJIvbGaQCay8zC9bulGQ/kOYDOwwVBGr0WyWA1sUTLZsuXpa');