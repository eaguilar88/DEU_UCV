...
func (_mock *MockRepository) GetPendingGroupRequestsCounts(ctx context.Context, faculty entities.Faculty) ([]entities.FacultyPendingCount, error) {
...
func (_c *MockRepository_GetPendingGroupRequestsCounts_Call) Run(run func(ctx context.Context, faculty entities.Faculty)) *MockRepository_GetPendingGroupRequestsCounts_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockRepository_GetPendingGroupRequestsCounts_Call) RunAndReturn(run func(ctx context.Context, faculty entities.Faculty) ([]entities.FacultyPendingCount, error)) *MockRepository_GetPendingGroupRequestsCounts_Call {
	_c.Call.Return(run)
	return _c
}
