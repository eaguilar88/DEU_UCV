...
func scanGroup(row scannable) (models.ExtensionGroup, error) {
	...
	err := row.Scan(
		...
		&group.EndorsementID,
		&group.EndorserID,
		&group.EndorserFirstName,
		&group.EndorserLastName,
		&group.Objective,
		&group.Location,
		&group.IsActive,
		&group.CreatedAt,
...
func newGroupToModel(group entities.ExtensionGroup) models.ExtensionGroup {
	return models.ExtensionGroup{
		...
		EndorsementID: group.Endorsement.ID,
...
func newGroupFromModel(group models.ExtensionGroup) entities.ExtensionGroup {
	...
	return entities.ExtensionGroup{
		...
		Endorsement: entities.Endorsement{
			ID: group.EndorsementID,
			Reviewer: entities.User{
				ID:        group.EndorserID,
				FirstName: group.EndorserFirstName,
				LastName:  group.EndorserLastName,
			},
		},
		Objective: objective,
		Location:  location,
